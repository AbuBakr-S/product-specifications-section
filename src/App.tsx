  ...
  return (
    <main className="p-4 min-w-[375px]">
      ...
      <section className="mt-16 mx-4">
        <nav role="tablist" aria-label="product-categories" className="flex overflow-x-scroll space-x-6 border-b">
          <button
            role="tab"
            aria-selected="true"
        ...
        <div className="pointer-events-none absolute top-0 right-8 w-12 h-full bg-gradient-to-l from-white to-transparent" />
        <section
          role="tabpanel"
          id="tab-panel-1"
